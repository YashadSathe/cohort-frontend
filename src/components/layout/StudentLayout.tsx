    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-background border-b border-border z-50 flex items-center px-4">
        ...
        <div className="flex items-center gap-3">
          <NavLink to="/student/notifications" className="relative p-2 hover:bg-muted rounded-lg">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2 px-2">
                ...
                <span className="hidden md:block text-sm font-medium">{user?.name || 'Student'}</span>
